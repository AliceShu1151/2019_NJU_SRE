...
precision1 = matrix[0][0]/(matrix[0][0]+matrix[1][0]+matrix[2][0]+matrix[3][0]+matrix[4][0])
precision2 = matrix[1][1]/(matrix[0][1]+matrix[1][1]+matrix[2][1]+matrix[3][1]+matrix[4][1])
precision3 = matrix[2][2]/(matrix[0][2]+matrix[1][2]+matrix[2][2]+matrix[3][2]+matrix[4][2])
precision4 = matrix[3][3]/(matrix[0][3]+matrix[1][3]+matrix[2][3]+matrix[3][3]+matrix[4][3])
precision5 = matrix[4][4]/(matrix[0][4]+matrix[1][4]+matrix[2][4]+matrix[3][4]+matrix[4][4])
print("P1 precision score: "+ str(precision1))
print("P2 precision score: "+ str(precision2))
print("P3 precision score: "+ str(precision3))
print("P4 precision score: "+ str(precision4))
print("P5 precision score: "+ str(precision5))
